...
The [Quickstart](../../../getting-started/quickstart.md) gets you started, but,
...
[installation documents](../../../getting-started/install-epinio.md).

:::

This tutorial uses
[Rancher Desktop](../../operator/install-scenarios/install_epinio_on_rancher_desktop.md)
...
[log in](../../../reference/cli/epinio_login.md) with the binary you
downloaded:
...
[port forwarding](../../operator/networking/port_forwarding.md) page.
