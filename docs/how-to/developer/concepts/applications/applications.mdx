...
This guide explores working with applications. Applications are deployable workloads that Epinio builds, deploys, and manages on Kubernetes. For more information, see the [applications](../../../../reference/configuration/supported_applications.md) reference page.
...
Provide your application source to Epinio. If you have an [application manifest](../../../../reference/configuration/manifests.md) you can upload it directly. Otherwise, you can provide your source in any of the following ways:
...
Assign your application to a [namespace](../namespaces/namespaces.mdx) and provide it a name. You can also configure the number of instances, set [custom routes](../custom_routes.md), define environment variables, and, depending on the selected [application chart](../app-charts/app-charts.mdx), configure additional chart-specific settings.
