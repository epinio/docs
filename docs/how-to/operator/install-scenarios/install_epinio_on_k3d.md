...
Follow [wildcard DNS setup](../dns/wildcard-dns.md) to define the domain name you want to use for Epinio.

Then, continue with the [Epinio installation process](../../../getting-started/install-epinio.md).
...
In case of issues with Epinio's Traefik component or Ingress controllers, refer to the [Traefik](../cluster-prerequisites.md#traefik) section in the
[Advanced Topics](../cluster-prerequisites.md) document.
