...
Follow the [wildcard DNS setup](../dns/wildcard-dns.md) to install DNS for Epinio in your environment.
...
In case of trouble with Epinio's Traefik component refer to the [Traefik](../cluster-prerequisites.md#traefik) section in the [Advanced Topics](../cluster-prerequisites.md) document.
