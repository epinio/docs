...
The [Install Epinio](../../../getting-started/install-epinio.md#ingress-controller) page has more details.
...
The most important setting is `Domain`, explained [here](../dns/dns_setup.md) in DNS setup.
...
Rancher and Epinio each integrate with your identity provider separately. To align operator sign-in with the same accounts and groups you use in Rancher, see [Rancher-aligned SSO](../identity-access/configuring_rancher_sso.md).
