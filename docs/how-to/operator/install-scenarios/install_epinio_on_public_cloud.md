...
Follow the [Epinio installation process](../../../getting-started/install-epinio.md).

## Troubleshooting

If you have issues using Epinio's Traefik component
or Ingress controllers,
refer to the [Traefik](../cluster-prerequisites.md#traefik) section
in the [Advanced Topics](../cluster-prerequisites.md) document.
