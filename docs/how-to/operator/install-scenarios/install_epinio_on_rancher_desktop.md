...
* [epinio helm chart 1.14.0\](https://github.com/epinio/helm-charts/releases/tag/epinio-1.14.0\)
...
1. Install the [Epinio CLI](../../../getting-started/install-cli.md).

1. Follow the [Epinio installation process](../../../getting-started/install-epinio.md). It uses:
