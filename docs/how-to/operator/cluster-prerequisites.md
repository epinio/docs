...
[Traefik](../../getting-started/install-epinio.md#ingress-controller)
...
[certificate issuers documentation](./networking/certificate_issuers.md)
...
(with the [`epinio push`](../../reference/cli/epinio_push.md) command),
...
See [Setup external S3](./cluster-config/setup_external_s3.md).
...
and configure as an ["external" registry](./cluster-config/setup_external_registry.md)
...
In this mode [`epinio push`](../../reference/cli/epinio_push.md)
