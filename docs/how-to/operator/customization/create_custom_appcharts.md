...
and register them in Epinio, so [their developers can use them](./using_custom_appcharts.md).
...
[Application Chart Reference](../../../reference/customization/appcharts.md#configuration).
