...
- [OIDC authentication](../../../reference/security/authentication_oidc.md) (Epinio docs)
- [Groups and roles mapping](../../../reference/security/authentication_oidc.md#groups-and-roles-mapping) (Epinio docs)
