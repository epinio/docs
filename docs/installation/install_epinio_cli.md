...
- `epinio_1.13.7_checksums.txt.pem`,
- `epinio_1.13.7_checksums.txt.sig`,
- `epinio_1.13.7_checksums.txt`


```
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.6/epinio_1.13.7_checksums.txt.pem
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.6/epinio_1.13.7_checksums.txt.sig
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.6/epinio_1.13.7_checksums.txt
```
...
cosign verify-blob \
	...
	--cert      epinio_1.13.7_checksums.txt.pem \
	--signature epinio_1.13.7_checksums.txt.sig \
	epinio_1.13.7_checksums.txt
```
...
```
sha256sum --ignore-missing -c epinio_1.13.7_checksums.txt
```
