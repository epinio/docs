...
```
curl -LO https://github.com/epinio/epinio/releases/download/v1.12.0/epinio_1.13.0_checksums.txt.pem
curl -LO https://github.com/epinio/epinio/releases/download/v1.12.0/epinio_1.13.0_checksums.txt.sig
curl -LO https://github.com/epinio/epinio/releases/download/v1.12.0/epinio_1.13.0_checksums.txt
```
