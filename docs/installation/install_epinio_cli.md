...
```
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.9/epinio_1.13.10_checksums.txt.pem
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.9/epinio_1.13.10_checksums.txt.sig
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.9/epinio_1.13.10_checksums.txt
```
