...
```
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.10/epinio_1.14.0_checksums.txt.pem
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.10/epinio_1.14.0_checksums.txt.sig
curl -LO https://github.com/epinio/epinio/releases/download/v1.13.10/epinio_1.14.0_checksums.txt
```
