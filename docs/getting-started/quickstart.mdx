...
helm upgrade --install epinio epinio/epinio \
    ...
    --set epinioUI.ingress.enabled=true \
    --set epinioUI.uiURL="https://$EPINIO_DOMAIN" \
    --set epinioUI.allowedOrigins="https://$EPINIO_DOMAIN" \
    --set dex.ui.redirectURI="https://$EPINIO_DOMAIN/auth/verify/"
```
