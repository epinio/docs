---
sidebar_label: Staging configuration override
title: Staging configuration override at trigger time
description: Override staging workload configurations at build trigger-time using the Epinio API.
keywords: [kubernetes, epinio, staging, customization, API, StageRequest]
doc-type: [how-to]
doc-topic: [epinio, how-to, customize, staging]
...
- [API reference](../../references/api.md) for the full OpenAPI spec and staging endpoint details
