...
Configurations in Epinio are managed by the [epinio configuration](../cli/configuration/epinio_configuration.md)
command hierarchy.

The connections between configurations and applications specifically are managed by the
[bind](../cli/configuration/epinio_configuration_bind.md) and [unbind](../cli/configuration/epinio_configuration_unbind.md) commands.
