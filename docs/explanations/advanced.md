...
When installing Epinio, the user can choose to use an external S3 compatible storage or let Epinio install either Minio or s3gw on the cluster ([See how to here](../howtos/customization/setup_external_s3.md)).
