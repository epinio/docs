...
Congrats, you have completed all of the prerequisites to develop Epinio! Check out how to get started with the [Epinio Rancher Extension](./extension) or [Standalone Application](./standalone). Looking forward to your first PR!
