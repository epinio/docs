---
sidebar_label: 'Release the UI'
sidebar_position: 4
title: 'Releasing the Epinio UI'
description: How to build and release the Epinio UI, update the Helm charts, and publish the extension for both embedded and standalone deployments.
