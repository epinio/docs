...
```bash
curl -o epinio -L https://github.com/epinio/epinio/releases/download/vv1.3.0/epinio-linux-x86_64
```

### MacOS

```bash
curl -o epinio -L https://github.com/epinio/epinio/releases/download/vv1.3.0/epinio-darwin-x86_64
```

### Windows

```bash
 curl -LO https://github.com/epinio/epinio/releases/download/vv1.3.0/epinio-windows-x86_64.zip
```
