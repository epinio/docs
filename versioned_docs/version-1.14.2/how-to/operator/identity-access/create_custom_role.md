...
As described in the [Authorization reference](../../../reference/security/authorization.md),
...
Check the [Authorization reference](../../../reference/security/authorization.md) for the list of actions
assignable to roles.
