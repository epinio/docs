...
Read more on how to use Let's Encrypt with Epinio in the [certificate issuers](./networking/certificate_issuers.md) documentation.

:::

Kubernetes accesses the Epinio registry (TLS or not) differently depending on installation flags.
There is more detail in the [Epinio registry](./cluster-prerequisites.md#container-registry) documentation.
